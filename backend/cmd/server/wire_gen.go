...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	usageBoardRepository := repository.NewUsageBoardRepository(db)
	usageBoardService := service.NewUsageBoardService(usageBoardRepository)
	usageBoardHandler := handler.NewUsageBoardHandler(usageBoardService)
