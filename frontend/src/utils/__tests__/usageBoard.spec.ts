...
import { boardChartGeometry, boardDefaultRange, boardMonthLastDay, formatUsageBoardTokens, usageBoardTokenUnit, validateBoardRange, UsageBoardChartType, UsageBoardValidation } from '../usageBoard'
...
describe('usage board presentation', () => {
  it('formats all displayed token counts as millions', () => {
    ...
    expect(usageBoardTokenUnit(99_999_999)).toBe('百万')
    expect(formatUsageBoardTokens(100_000_000)).toBe('1')
    expect(usageBoardTokenUnit(100_000_000)).toBe('亿')
  })
