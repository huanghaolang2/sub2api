<template>
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      ...
      <button v-if="redeemVisible" @click="router.push('/redeem')" class="group flex w-full items-center gap-4 rounded-xl bg-gray-50 p-4 text-left transition-all duration-200 hover:bg-gray-100 dark:bg-dark-800/50 dark:hover:bg-dark-800">
...
const redeemVisible = isUserFeatureVisible(UserFeature.REDEEM)
