...
import { boardChartGeometry, formatUsageBoardTokens, usageBoardTokenUnit, UsageBoardChartType } from '@/utils/usageBoard'
...
const geometry = computed(() => boardChartGeometry(props.data, props.type, width.value))
