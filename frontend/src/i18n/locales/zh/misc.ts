export default {
  usageBoard: {
    title: '使用看板', statistics: '现有统计', source: '数据来源：使用记录', timezone: '统计时区', filters: '查询条件',
    granularity: '时间粒度', day: '日', week: '周', month: '月', startDate: '开始日期', endDate: '结束日期', startMonth: '开始月份', endMonth: '结束月份',
