export default {
  usageBoard: {
    ...
    trend: 'Token usage trend (millions)', chartType: 'Chart type', line: 'Line', bar: 'Bar', legend: 'API key legend', chartLabel: 'Tokens by API key and time period (millions)', tokenUnit: 'million',
    ...
    partial: 'Partial period', noData: 'No data', results: 'Usage results', rowCount: '{count} rows', period: 'Time period', tokens: 'Total token usage (millions)',
